    ...
    >
      <TiltCard>
        <div className="card-frame rounded-3xl px-6 py-9 sm:px-10 flex flex-col items-center">
          ...
          >
            {ev.id === "muhurtham" ? <Flame size={26} className="animate-[#8f1d3a]" /> : <Sparkles size={26} />}
          </motion.div>
          ...
          <div className="pt-2 pb-1 overflow-visible">
            <h3 className="font-script text-5xl sm:text-6xl text-gradient-sindoor leading-snug px-3">
              {ev.title}
            </h3>
          </div>
