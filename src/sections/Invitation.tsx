  ...
  return (
    <div className="mt-10">
      ...
      >
        ...
        >
          <span className="font-script text-xl text-[#5d3603] leading-snug px-1 pt-1">{invite.monogram}</span>
        </motion.button>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="pt-2 pb-1 overflow-visible">
        <p className="font-script text-4xl text-gradient-sindoor leading-snug px-2">{name}</p>
      </div>
